...
pub use contract::{
    ...
    GenerationMeasurements, GenerationOutput, GenerationReceipt, ImageOutputSink, ImageRequest,
    ImageRequestReceipt, MAX_BACKEND_LABEL_BYTES, MAX_IMAGE_DIMENSION, MAX_PROMPT_BYTES,
    NativeRuntimeReceipt, NoopProgram, Profile, ProfileArtifacts, ProfileReceipt, SdcppOptions,
    StepProgram, StepReceipt,
};
pub use error::{Error, Result};
pub use image::{
    AdvancedGenerationOutput, AdvancedGenerationReceipt, AdvancedImageRequest,
    AdvancedImageRequestReceipt, ImagePixels, LoraBinding, LoraBindingReceipt,
    MAX_REFERENCE_IMAGES, MAX_REQUEST_LORAS, MAX_VAE_TENSOR_RANK, PixelReceipt, VaeImageOutput,
    VaeOperationReceipt, VaeTensor, VaeTensorOutput,
};
...
pub const ADAPTER_CONTRACT_VERSION: u32 = 3;
