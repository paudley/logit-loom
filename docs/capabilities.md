...
| Aggregate text-mechanics execution | `execute_text_mechanics`, `TextMechanicsRequest`, `TextMechanicsReceiptV2` | Model-free plan/checkpoint/steering/cleanup/cancellation accounting, strict adapter compilation, and ordinary/speculative composition; compatible-model execution remains opt-in |
