...
| Versioned stable-diffusion.cpp boundary | Companion ABI v1, image ABI v2, program ABI v3, model-block ABI v4, model-block application ABI v5, Krea activation ABI v6, and `probe_companion` | Exact patch compilation is retained model-free evidence; Rust symbol, descriptor, callback, arena, resident-input, resource-accounting, and cleanup paths have model-free tests. Device probing and model execution remain opt-in. |
